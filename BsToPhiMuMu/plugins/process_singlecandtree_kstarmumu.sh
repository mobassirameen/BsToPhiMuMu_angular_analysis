...
do
    ...
    ./sel mc.lite mc cutopt root://cmseos.fnal.gov//eos/uscms/store/user/ckar/BsToMuMuPhi-KstarMuMu_2016MINI_Correction_Iso_v2.root BsToMuMuPhi-KstarMuMu_2016MINI_Correction_Iso_v2 -s $((2000000*$((num-1))))  -n 2000000
