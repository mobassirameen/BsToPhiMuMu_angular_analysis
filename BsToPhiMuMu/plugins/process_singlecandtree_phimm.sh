...
do
    ...
    ./sel mc.lite mc cutopt root://cmseos.fnal.gov//eos/uscms/store/user/ckar/BsToPhiMuMu_2018_SignalMC_Mini_Correction_Iso.root BsToPhiMuMu_2018_SignalMC_Mini_Correction_Iso -s $((2000000*$((num-1))))  -n 2000000
