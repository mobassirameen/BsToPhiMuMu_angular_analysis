...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(
            'file:/afs/cern.ch/work/c/ckar/BSTOPHIMUMU/test_analyzer/CMSSW_10_2_14/src/Run2_Bstophimumu/BsToPhiMuMu/python/Charmonium/0C4CA5EF-083D-4E4E-AA4F-FBCF50BBB59D.root'))
...
from PhysicsTools.PatAlgos.patSequences_cff import patCandidates

## 2017: add pat as task
...
task.add(process.cleanPatTracks) 
#make patTracks
...
task.add(process.cleanMuonTriggerMatchHLT)
task.add(process.cleanTrackTriggerMatchHLT)
#########################
### Remove unused PAT ###
#########################
...
process.patOOTPhotons.addPFClusterIso = cms.bool(False)
...
process.ntuple = cms.EDAnalyzer(
    ...
    OutputFileName = cms.string("BsToPhiMuMu_2017.root"),
...
##    MuMuMaxInvMass = cms.untracked.double(4.8), # [GeV/c2]
    ...
    MuMuMinInvMass2 = cms.untracked.double(4.0), # [GeV/c2]   
    MuMuMaxInvMass1 = cms.untracked.double(2.9), # [GeV/c2]
...
process.ntupPath.associate(task)
