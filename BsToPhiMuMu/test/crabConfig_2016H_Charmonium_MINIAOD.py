...
config.General.requestName = 'job_crab_data_Charmonium_finaljob_MINIAOD_CMSSW10218_16H_v2'
config.General.workArea = 'crab_data_Charmonium_finaljob_MINIAOD_CMSSW10218_16H_v2'
...
config.Data.inputDataset = '/Charmonium/Run2016H-17Jul2018-v1/MINIAOD'
