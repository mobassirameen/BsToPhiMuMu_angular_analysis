...
from bstophimumu_2016_cfi_hltjpsi import process  ### input cfi changed to check with HLT_DoubleMu4_3_JPSi_Displaced_v* path
...
##    matchedCuts           = cms.string('path("HLT_DoubleMu4_LowMassNonResonantTrk_Displaced*",0,0)'),
    matchedCuts           = cms.string('path("HLT_DoubleMu4_3_Jpsi_Displaced*",0,0)'), ## HLT path changed
...
##    ('HLT_DoubleMu4_LowMassNonResonantTrk_Displaced',  'hltLowMassNonResonantTkVertexFilter') 
    ('HLT_DoubleMu4_3_Jpsi_Displaced',  'hltDisplacedmumuFilterDoubleMu43Jpsi')   ## filter changed 
    ]
