...
from bstophimumu_2016_cfi_PSIP_trk_mar10 import process 
...
'/store/mc/RunIISummer16DR80Premix/BsToPsiPhi_BMuonFilter_SoftQCDnonD_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/100000/028CBC53-1ADC-E611-B7E9-0025905B8564.root')
...
g_TriggerNames_LastFilterNames = [
    ...
    #('HLT_DoubleMu4_JpsiTrk_Displaced',  'hltDisplacedmumuFilterDoubleMu4Jpsi')   ## filter changed
    ('HLT_DoubleMu4_PsiPrimeTrk_Displaced', 'hltDisplacedmumuFilterDoubleMu4PsiPrime') ## filter changed
    ]
