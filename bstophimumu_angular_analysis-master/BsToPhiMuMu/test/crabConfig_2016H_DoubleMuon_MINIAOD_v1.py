...
config.General.requestName = 'job_crab_data_DoubleMuonLowMass_finaljob_MINIAOD_CMSSW10218_16H_v5'
config.General.workArea = 'crab_data_DoubleMuonLowMass_finaljob_MINIAOD_CMSSW10218_16H_v5'
...
config.Data.inputDataset = '/DoubleMuonLowMass/Run2016H-17Jul2018-v1/MINIAOD'
